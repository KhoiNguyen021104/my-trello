...
function SelectSmall() {
  ...
  return (
    <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
      ...
      >
        <MenuItem value="light"><Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}><LightModeIcon fontSize='small'/> Light</Box></MenuItem>
...
function App() {
  return (
    <>
      ...
      <br />
      <Typography variant="h3" color="text.secondary">Hello World!</Typography>
      <br />
